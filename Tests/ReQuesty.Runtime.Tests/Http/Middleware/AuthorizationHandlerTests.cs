...
public class AuthorizationHandlerTests : IDisposable
{
    ...
    public AuthorizationHandlerTests()
    {
        ...
        Mock<BaseBearerTokenAuthenticationProvider> mockAuthenticationProvider = new(mockAccessTokenProvider.Object);
    ...
    {
        // Arrange
        HttpRequestMessage httpRequestMessage = new(HttpMethod.Get, "https://graph.microsoft.com/me");
    ...
    {
        // Arrange
        HttpRequestMessage httpRequestMessage = new(HttpMethod.Get, "https://example.com");
    ...
    {
        // Arrange
        HttpRequestMessage httpRequestMessage = new(HttpMethod.Get, "https://graph.microsoft.com");
        httpRequestMessage.Content = new ByteArrayContent(Encoding.UTF8.GetBytes("test"));

        HttpResponseMessage httpResponse = new(HttpStatusCode.Unauthorized);
