...
namespace ReQuesty.Runtime.Serialization.Multipart.Tests.Mocks;
...
public class UnionTypeMock : IParsable, IComposedTypeWrapper
{
    ...
    {
        UnionTypeMock result = new();
        string? discriminator = parseNode.GetChildNode("@odata.type")?.GetStringValue();
