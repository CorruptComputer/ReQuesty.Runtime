...
namespace ReQuesty.Runtime.Serialization.Multipart.Tests;
public class MultipartSerializationWriterFactoryTests
{
    ...
    {
        Abstractions.Serialization.ISerializationWriter multipartWriter = _multipartSerializationFactory.GetSerializationWriter(_multipartSerializationFactory.ValidContentType);
    ...
    public void ThrowsArgumentOutOfRangeExceptionForInvalidContentType()
    {
        ...
        ArgumentOutOfRangeException exception = Assert.Throws<ArgumentOutOfRangeException>(() => _multipartSerializationFactory.GetSerializationWriter(streamContentType));
    ...
    {
        ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() => _multipartSerializationFactory.GetSerializationWriter(contentType!));
