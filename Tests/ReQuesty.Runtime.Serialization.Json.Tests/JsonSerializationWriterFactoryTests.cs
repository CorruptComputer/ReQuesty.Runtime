...
namespace ReQuesty.Runtime.Serialization.Json.Tests
{
    public class JsonSerializationWriterFactoryTests
    {
        ...
        {
            Abstractions.Serialization.ISerializationWriter jsonWriter = _jsonSerializationFactory.GetSerializationWriter(_jsonSerializationFactory.ValidContentType);
