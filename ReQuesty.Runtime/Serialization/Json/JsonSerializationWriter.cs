...
public class JsonSerializationWriter : ISerializationWriter, IDisposable
{
    ...
    private readonly ReQuestyJsonSerializationContext _reQuestyJsonSerializationContext;
    ...
    public JsonSerializationWriter(ReQuestyJsonSerializationContext reQuestyJsonSerializationContext)
    {
        _reQuestyJsonSerializationContext = reQuestyJsonSerializationContext;
        writer = new Utf8JsonWriter(_stream, new JsonWriterOptions
        {
            Encoder = reQuestyJsonSerializationContext.Options.Encoder,
            Indented = reQuestyJsonSerializationContext.Options.WriteIndented
        });
    }
    ...
    public void WriteStringValue(string? key, string? value)
    {
        if (value != null)
        {
            ...
            JsonSerializer.Serialize(writer, value, TypeConstants.StringType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteBoolValue(string? key, bool? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.BooleanType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteByteValue(string? key, byte? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.ByteType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteSbyteValue(string? key, sbyte? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.SbyteType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteIntValue(string? key, int? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value, TypeConstants.IntType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteFloatValue(string? key, float? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.FloatType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteLongValue(string? key, long? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.LongType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteDoubleValue(string? key, double? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.DoubleType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteDecimalValue(string? key, decimal? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.DecimalType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteGuidValue(string? key, Guid? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.GuidType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteDateTimeOffsetValue(string? key, DateTimeOffset? value)
    {
        ...
        if (value.HasValue)
        {
            JsonSerializer.Serialize(writer, value.Value, TypeConstants.DateTimeOffsetType, _reQuestyJsonSerializationContext);
        }
    }
    ...
    public void WriteEnumValue<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T>(string? key, T? value) where T : struct, Enum
    {
        ...
        if (value.HasValue)
        {
            ...
            {
                WriteStringValue(null, EnumHelpers.GetEnumStringValue(value.Value));
            }
        }
    }
    ...
    {
        IParsable[] filteredAdditionalValuesToMerge = (IParsable[])Array.FindAll(additionalValuesToMerge, static x => x is not null);
        if (value != null || filteredAdditionalValuesToMerge.Length > 0)
        {
            // until interface exposes WriteUntypedValue()
            bool serializingUntypedNode = value is UntypedNode;
            ...
            {
                UntypedNode? untypedNode = value as UntypedNode;
            ...
            {
                bool serializingScalarValue = value is IComposedTypeWrapper;
                ...
                foreach (IParsable additionalValueToMerge in filteredAdditionalValuesToMerge)
                {
    ...
    private void WriteNonParsableObjectValue<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T>(string? key, T value)
    {
        ...
        {
            foreach (PropertyInfo oProp in value.GetType().GetProperties())
            {
    ...
    private void WriteUntypedObject(string? key, UntypedObject? value)
    {
        if (value != null)
        {
            ...
            foreach (KeyValuePair<string, UntypedNode> item in value.GetValue())
            {
    ...
    private void WriteUntypedArray(string? key, UntypedArray? array)
    {
        if (array != null)
        {
            ...
            writer.WriteStartArray();
            foreach (UntypedNode item in array.GetValue())
            {
