...
public class UriReplacementHandlerOption(bool isEnabled, IEnumerable<KeyValuePair<string, string>> replacementPairs) : IUriReplacementHandlerOption
{
    private readonly bool isEnabled = isEnabled;

    private readonly IEnumerable<KeyValuePair<string, string>> replacementPairs = replacementPairs;
    ...
    public UriReplacementHandlerOption(bool isEnabled = false) : this(isEnabled, []) { }
    ...
    public Uri? Replace(Uri? original)
    {
        ...
        UriBuilder newUrl = new(original);
